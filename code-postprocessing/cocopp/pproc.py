...
"""
    ...
    """
        ...
        elif len(self._instance_multipliers) != len(instance_multipliers) or not all(self._instance_multipliers == instance_multipliers):
            warnings.warn("instance multipliers changed " + str((self, self.instancenumbers, self._instance_multipliers, instance_multipliers)))
        self._instance_multipliers = instance_multipliers
